# Vendored from:
# https://raw.githubusercontent.com/drakxtwo/vl53l1x_pico/main/vl53l1x.py
# (downloaded verbatim; do not hand-edit the register configuration blob below)
#
# Device: ST VL53L1X laser time-of-flight distance sensor (I2C addr 0x29,
# range up to ~4 m). Wiring, links and pull-up guidance live in the
# droid_sense module docstring, which is the friendly wrapper around this
# driver; kid code should normally use droid_sense.Ranger, not this class.
import machine
